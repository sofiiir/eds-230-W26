...
result <- diff1(initialC = 1000, nx =10, dx = 1, nt = 8, dt =1, D = 1, area = 1000)
...
filled.contour(t(result$conc), xlab = "Distance", ylab = "Time")
...
## sChange parameters (diffusivity D, and space and time steps (dx, dt)) {.scrollable}
...
# single column (time)
plot(resfast_fixtime$conc[,3], ylab = "Concenttration for location 3", xlab = "Time")
...
ggplot(spatial_metrics, aes(time, cvar)) +
  geom_line() +
