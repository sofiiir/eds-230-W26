...
# total effect - accounts for parameter interactions (influence between parameter)
...
print(sens_Catm_Sobol2)
```

Total indices is accounting for interaction or covariance between the parameters impact on the output.
