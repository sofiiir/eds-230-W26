...
ggplot(both, aes(x = mean_annual_yields)) +
  geom_histogram() +
  geom_vline(xintercept = mean(both$mean_annual_yields), col = "hotpink")

# look at response of conductance to the two most important variables
ggplot(both, aes(Pcoeff2, mean_annual_yields, col = intercep)) +
  geom_point() +
  labs(y = "Mean Annual Yield Anamoly (ton/acre)", x = "Precip coeff 2")
