...
## Sensitivity to Energy Threshold is not linear {.scrollable}
...
# Questions on Almond Assignment? {.scrollable}

-   Can work on it in class
-   Ask if you need help
-   Equation's explanation is in the paper text and table caption, but we can discuss if there are questions
-   Remember to submit as PDF or HTML
    -   If you submit as HTML, make sure any images (figures etc.) render correctly after you submit on canvas
    -   Might need to enable embedding resources in Quarto document properties
